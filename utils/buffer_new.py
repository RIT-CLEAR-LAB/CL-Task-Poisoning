...
class Buffer:
    ...
    def get_data(self, size: int, transform: nn.Module = None, mode = "random", return_index=False, **kwargs) -> Tuple:
        ...
        # print('choice', choice)
        # print('self.examples[choice]', self.examples[choice])
        # print('self.labels[choice]', self.labels[choice])
        # print('type(self.examples)', type(self.examples[choice]))
        # print('type(self.labels)', type(self.labels[choice]))
        # ## print the device of self.examples and self.labels
        # print('self.examples.device', self.examples.device)
        # print('self.labels.device', self.labels.device)
