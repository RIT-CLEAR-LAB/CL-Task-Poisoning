...
models = ["er"]#, "der", "derpp", "er_ace"]
buffer_sizes = [500,2000] #[200, 500, 2000]
poisoning_rates = [5, 10]

for buffer_size, model, poisoning_rate in itertools.product(buffer_sizes, models, poisoning_rates):
    args_dict = dict(
        dataset='seq-cifar100-backdoor-attack',
        model=model,
        n_epochs=50,
        nowand=1,
        non_verbose=1,
        ...
        n_label_flip_poisonings = None, # fails without this
        ...
        buffer_retrieve_mode='uniform_balanced',
        buffer_size=buffer_size,
        n_backdoor_poisonings=1,
    ...
    file = f"results/backdoor_poison/cifar_{model}_{buffer_size}_{poisoning_rate}_(5-20)_2.json"
    main(args, file)